...
// No se dibuja porque, aunque CollectionProducto maneja una lista de productos, esa relación no siempre se representa en el diagrama. A veces se asume que la clase tiene productos dentro sin necesidad de ponerlo explícito en el diagrama, porque es algo lógico cuando trabajas con colecciones. Es decir, se entiende que si hay una lista de productos, está conectada a Producto, pero no se dibuja para no complicar el diagrama.
